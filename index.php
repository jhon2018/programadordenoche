...
<body>
  ...
  <div class="container">
    ...
    <header class="jumbotron " >
      <h1 class="banner display-4 text-center">
 ...
 <div class="carousel-item active">
  ...
  <div class="btn-group-sm">		
        <a href="https://www.facebook.com/groups/ProgramadorDeNoche"  title="Siguenos y Unete..!" target="_blank" class="btn btn-primary btn-lg">Facebook</a>
	    <a href="https://api.whatsapp.com/send?phone=51945430381"  target="_blank" class="btn btn-success btn-lg">Whatsapp </a>
		<a href="https://www.instagram.com/programadordenoche/"  title="Forma parte de nuestra Familia..!" target="_blank" class="btn btn-warning btn-lg">Instagran </a>
	</div>
		  
		
		
		  <!--BANNER NORMAL-->
		  <!--<strong>PROGRAMADOR DE NOCHE</strong></h1>
<h5 class="lead"><strong>Bienvenidos a nuestra sitio ofical en donde encontraras material de descarga referente a tecnologia pulsando en los enlaces de publicidad y omitiendo, tenemos como objectivo relacionar a usted de ser parte de nuestro grupo y ver el comportamiento de su persona y   aportando conocimiento,preguntas refrente a "TI" en nuestas redes sociales  quí abajo, cualquier falta lamentablemente sera bloqueado por el admim, de atemano te agradesco que estes con nosotros y disfruta de nuestros contenidos. </strong> &nbsp; &nbsp; &nbsp; &nbsp; </h5>-->
		
	
		  <!--TERMINA AQUI BANNER NORMAL-->
    </header>
...
<p class="card-text">Las nuevas funciones de las actualizaciones recientes de Windows te ayudarán a administrar tu tiempo, aumentar la seguridad y ser más creativo con Windows 10. </p>
          ...
          <div class="card-footer ">
            <a href="https://fc.lc/EdZLFtUr"  target="_blank" class="btn btn-danger "  >Descargalo Gratis! <span class="badge badge-warning">New</span></a>
          </div>
        </div>
      </div>
...
<p class="card-text">Entre las novedades de Windows Server 2016, se ha hablado de algunos aspectos como las nuevas capas de seguridad, los contenedores integrados, mejora del almacenamiento y mayor eficacia en el desarrollo de en la nube.</p>
          ...
          <div class="card-footer">
            <a href="https://fc.lc/IF04n1u"  target="_blank" class="btn btn-danger">Descargalo Gratis! <!--<span class="badge badge-warning"> </span>--></a>
          </div>
        </div>
      </div>
...
<p class="card-text"> SQL Server 2019 está ya en versión RTM desde hace ya algo más de 1 mes.SQL Server 2019 incorpora extensibilidad de lenguaje en el marco de Machine Learning Services. La primera implementación que ha tenido esta extensibilidad la ha realizado Microsoft y es ni más ni menos que JAVA.</p>
          ...
          <div class="card-footer">
            <a href="https://fc.lc/VO3s"  target="_blank" class="btn btn-danger">Descargalo Gratis! <span class="badge badge-warning">New</span></a>
          </div>
        </div>
      </div>
...
<p class="card-text">Aumenta el espacio de trabajo, mejora el selector de plantillas y las búsquedas, y el depurador de código es más rápido e inteligente, entre otras muchas optimizaciones. Las dos grandes mejoras de Microsoft Visual Studio 2019 son IntelliCode y Live Share.</p>
          ...
          <div class="card-footer">
            <a href="#" class="btn btn-danger">Descargalo Gratis! <span class="badge badge-warning">New </span></a>
          </div>
        </div>
      </div>
...
<p class="card-text">Adobe Dreamweaver es la herramienta más completa del mundo para diseñadores web y desarrolladores front-end. Combina una poderosa superficie de diseño y el mejor editor de código de su clase con sólidas herramientas de administración de sitios, para que pueda diseñar, codificar y administrar fácilmente sitios web.</p>
          ...
          <div class="card-footer">
            <a href="https://fc.lc/Fvq70" target="_blank" class="btn btn-danger">Descargalo Gratis! <span class="badge badge-warning">New</span></a>
          </div>
        </div>
      </div>   	
	  ...
	  <div class="col-lg-3 col-md-6 mb-4">	
        <div class="card h-100">
          ...
          <div class="card-footer">
            <a href="https://fc.lc/09Vsx" class="btn btn-danger">Descargalo Gratis! <span class="badge badge-warning">New!</span></a>
          </div>
        </div>
      </div>
	 ...
	 <div class="col-lg-3 col-md-6 mb-4">	
        <div class="card h-100">
          ...
          <div class="card-footer">
            <a href="https://fc.lc/14Egor" class="btn btn-danger">Descargalo Gratis! <span class="badge badge-warning">New!</span></a>
          </div>
        </div>
      </div>
     ...
     <div class="col-lg-3 col-md-6 mb-4">	
        <div class="card h-100">
          ...
          <div class="card-footer">
            <a href="https://fc.lc/0j66Ps" class="btn btn-danger">Descargalo Gratis! <!--<span class="badge badge-warning">x! </span>--></a>
          </div>
        </div>
      </div>	
        ...
        <div class="card h-100">
          ...
          <div class="card-footer">
            <a href="https://fc.lc/oiiUP2H" class="btn btn-danger">Descargalo Gratis! <span class="badge badge-warning">New! </span></a>
          </div>
        </div>
      </div>
        ...
        <div class="card h-100">
          ...
          <div class="card-footer">
            <a href="https://fc.lc/ezeSSkk" class="btn btn-danger">Descargalo Gratis! <!--<span class="badge badge-warning">Pendiente! </span>--></a>
          </div>
        </div>
      </div>	
...
<!--      <div class="col-lg-3 col-md-6 mb-4">	
        <div class="card h-100">
          <img src="img/visualstudio2019_00001.jpg" alt="" title="Desbloquea tu Adblock y omite los anuncios" width="100" height="120" class="card-img-top">
          <div class="card-body">
            <h5 class="card-title text-capitalize"><strong>Visual Studio 2019</strong></h5>
<p class="card-text">Aumenta el espacio de trabajo, mejora el selector de plantillas y las búsquedas, y el depurador de código es más rápido e inteligente, entre otras muchas optimizaciones. Las dos grandes mejoras de Microsoft Visual Studio 2019 son IntelliCode y Live Share.</p>
          </div>
          <div class="card-footer">
            <a href="#" class="btn btn-danger">Descargalo Gratis! <span class="badge badge-warning">x! </span></a>
          </div>
        </div>
      </div>-->
  ...
  <footer class="py-3 bg-dark">
    <div class="container">
		<div class="col">
      <h3 class="m-1 text-center text-warning  "><?php  echo('Visitas: ' .$visitas );?></h3>
		
        </div>
		<div class="col">
      <h5 class="m-1 text-center text-white display-4">Copyright &copy; ProgramadorDeNoche</h5>
        </div>
	  <div class="col">
     <a href="https://www.facebook.com/jonathann.segura.9/" ><p class="text-center text-danger " >CEO: Jonathan Vera Segura</p></a>
    </div>
		</div>
    <!-- /.container -->
  </footer>
